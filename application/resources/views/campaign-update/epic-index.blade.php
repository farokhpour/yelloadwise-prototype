            ...
            <div style="background: #e3f2fd; padding: 2rem; border-radius: 8px; border-right: 4px solid #2196f3;">
                ...
                <div style="background: rgba(255,255,255,0.7); padding: 1rem; border-radius: 6px; margin-top: 1rem;">
                    ...
                    <ul style="color: #555; font-size: 0.85rem; margin: 0; padding-right: 1.5rem; line-height: 1.9;">
                        ...
                        <li><strong>🟡 در حال اجرا یا تمام شده (پرداخت نشده):</strong> افزایش هدف بدون محدودیت قابل انجام است، کاهش هدف فقط در صورتی که تعداد روز های دارای گزارش از تعداد هدف جدید کم تر باشد، تغییر تاریخ شروع به قبل از تاریخ شروع فعلی وجود ندارد و به جلو بردن آن فقط در صورتی امکان پذیر است که در تاریخ های بعدی گزارش کمپین وجود</li>
                    </ul>
                </div>
            </div>
        </div>
