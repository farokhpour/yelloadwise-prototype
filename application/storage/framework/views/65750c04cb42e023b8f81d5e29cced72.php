<div style="max-width: 1200px; margin: 0 auto;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 2rem; border-radius: 12px; color: white;">
            ...
            <p style="margin: 0; font-size: 2.5rem; font-weight: bold;"><?php echo e($campaign->cars); ?></p>
        ...
        <div style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 2rem; border-radius: 12px; color: white;">
            ...
            <p style="margin: 0; font-size: 2.5rem; font-weight: bold;">
                <?php echo e($campaign->started_at ? (int)$campaign->started_at->diffInDays(now()) : 0); ?>

            </p>
            <p style="margin: 0.5rem 0 0 0; font-size: 0.875rem; opacity: 0.8;">از <?php echo e($campaign->days); ?> روز</p>
        </div>
        ...
        <div style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); padding: 2rem; border-radius: 12px; color: white;">
            ...
            <p style="margin: 0; font-size: 2.5rem; font-weight: bold;"><?php echo e(rand(150, 500)); ?></p>
        ...
        <div style="height: 300px; display: flex; align-items: flex-end; justify-content: space-around; gap: 0.5rem; border-bottom: 2px solid #dee2e6; padding-bottom: 1rem;">
            ...
            <?php for($i = 0; $i < $days; $i++): ?>
                ...
                <div style="flex: 1; display: flex; flex-direction: column; align-items: center;">
                    <div style="width: 100%; background: linear-gradient(to top, #007bff, #0056b3); border-radius: 4px 4px 0 0; min-height: 20px; height: <?php echo e($height); ?>%; margin-bottom: 0.5rem; position: relative;">
                        <span style="position: absolute; top: -25px; left: 50%; transform: translateX(-50%); font-size: 0.875rem; font-weight: 600; color: #333;"><?php echo e($clicks); ?></span>
                    </div>
                    <span style="font-size: 0.75rem; color: #666; text-align: center;">روز <?php echo e($i + 1); ?></span>
                </div>
            <?php endfor; ?>
        </div>
            ...
            <tbody>
                <?php for($i = 1; $i <= $campaign->cars; $i++): ?>
                    ...
                    <tr style="border-bottom: 1px solid #dee2e6;">
                        <td style="padding: 1rem;">CAR-<?php echo e(str_pad($i, 3, '0', STR_PAD_LEFT)); ?></td>
                        <td style="padding: 1rem;"><?php echo e(ucfirst(str_replace('-', ' ', $route))); ?></td>
                        <td style="padding: 1rem; text-align: center; font-weight: 600; color: #007bff;"><?php echo e($minutes); ?> دقیقه</td>
                        <td style="padding: 1rem; text-align: center; font-weight: 600; color: #28a745;"><?php echo e($clicks); ?></td>
                    </tr>
                <?php endfor; ?>
            </tbody>
        </table>
...
<?php /**PATH /var/www/html/resources/views/campaigns/partials/report.blade.php ENDPATH**/ ?>