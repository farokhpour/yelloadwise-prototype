    ...
    <div style="background: white; padding: 3rem; border: 2px solid #dee2e6; border-radius: 8px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
            <div>
                ...
                <p style="margin: 0.25rem 0; color: #666;">کمپین: <?php echo e($campaign->name); ?></p>
                <p style="margin: 0.25rem 0; color: #666;">تاریخ فاکتور: <?php echo e($campaign->approved_at ? $campaign->approved_at->format('Y-m-d') : now()->format('Y-m-d')); ?></p>
                <p style="margin: 0.25rem 0; color: #666;">شماره فاکتور: INV-<?php echo e(str_pad($campaign->id, 6, '0', STR_PAD_LEFT)); ?></p>
            </div>
            <div style="text-align: right;">
                <h3 style="color: #333; margin-bottom: 1rem;">جزئیات کمپین:</h3>
                <p style="margin: 0.25rem 0; color: #666;">وضعیت: 
                    <?php if($campaign->status === 'waiting_payment'): ?> در انتظار پرداخت
                    ...
                    <?php else: ?> <?php echo e($campaign->status); ?>

                    <?php endif; ?>
                </p>
                <p style="margin: 0.25rem 0; color: #666;">مدت زمان: <?php echo e($campaign->days); ?> روز</p>
                <p style="margin: 0.25rem 0; color: #666;">وسایل نقلیه: <?php echo e($campaign->cars); ?> ماشین</p>
            </div>
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 2rem;">
            ...
            <tbody>
                <tr style="border-bottom: 1px solid #dee2e6;">
                    ...
                    <td style="padding: 1rem; text-align: center;"><?php echo e($campaign->days); ?> روز</td>
                    <td style="padding: 1rem; text-align: left;" class="ltr">$<?php echo e(number_format($campaign->cost_per_day ?? 0, 2)); ?></td>
                    <td style="padding: 1rem; text-align: left;" class="ltr">$<?php echo e(number_format(($campaign->cost_per_day ?? 0) * $campaign->days, 2)); ?></td>
                </tr>
                <tr style="border-bottom: 1px solid #dee2e6;">
                    <td style="padding: 1rem;">تعداد وسایل نقلیه</td>
                    <td style="padding: 1rem; text-align: center;"><?php echo e($campaign->cars); ?> ماشین</td>
                    <td style="padding: 1rem; text-align: left;">-</td>
                    <td style="padding: 1rem; text-align: left;">-</td>
                </tr>
                <tr style="border-bottom: 1px solid #dee2e6;">
                    <td style="padding: 1rem;">موقعیت‌ها</td>
                    <td style="padding: 1rem; text-align: center;"><?php echo e(count($campaign->locations)); ?> مسیر</td>
                    <td style="padding: 1rem; text-align: left;">-</td>
                    <td style="padding: 1rem; text-align: left;">-</td>
                </tr>
            </tbody>
        ...
        <div style="display: flex; justify-content: flex-start; margin-bottom: 2rem;">
            <div style="width: 300px;">
                <div style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #dee2e6;">
                    ...
                    <span class="ltr">$<?php echo e(number_format(($campaign->cost_per_day ?? 0) * $campaign->days, 2)); ?></span>
                </div>
                <div style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid #dee2e6;">
                ...
                <div style="display: flex; justify-content: space-between; padding: 1rem 0; background: #f8f9fa; margin-top: 1rem; border-radius: 4px; padding-left: 1rem; padding-right: 1rem;">
                    ...
                    <span style="font-weight: bold; font-size: 1.2rem; color: #28a745;" class="ltr">$<?php echo e(number_format($campaign->total_cost, 2)); ?></span>
                </div>
            </div>
        </div>
...
<?php /**PATH /var/www/html/resources/views/campaigns/partials/invoice.blade.php ENDPATH**/ ?>